...
CREATE TABLE `CutRecord` (
    ...
    `operationSetId` INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE `CutRecord` ADD CONSTRAINT `CutRecord_operationSetId_fkey` FOREIGN KEY (`operationSetId`) REFERENCES `OperationSet`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `OperationRecord` ADD CONSTRAINT `OperationRecord_operationSetId_fkey` FOREIGN KEY (`operationSetId`) REFERENCES `OperationSet`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
